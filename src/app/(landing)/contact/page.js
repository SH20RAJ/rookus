...
<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d117223.77996815203!2d85.32132625000001!3d23.343204800000002!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x39f4e104aa5db7dd%3A0xdc09d49d6899f43e!2sRanchi%2C%20Jharkhand!5e0!3m2!1sen!2sin!4v1728618878569!5m2!1sen!2sin" 
className='w-[80%] h-[80vh]' style={{border: 0}} allowFullScreen loading="lazy" referrerPolicy="no-referrer-when-downgrade" />
    </div>
      <div style={styles.container}>
        <div style={styles.info}>
          <div style={styles.title}>Get in Touch</div>
          <h1 style={{ fontSize: '1.5rem', color: '#f9a826' }}>Convey Your Ideas to Us</h1>
          <p style={{ fontSize: '0.875rem', color: '#fff', marginBottom: '2rem' }}>
          ...
          <div>
            <div style={{ display: 'flex', alignItems: 'center', marginBottom: '1rem' }}>
              ...
              <a href="tel:+919660673731" style={{ color: '#fff', textDecoration: 'none', marginLeft: '0.5rem' }}>+91 96606 73731</a>
            </div>
            <div style={{ display: 'flex', alignItems: 'center', marginBottom: '1rem' }}>
              <span role="img" aria-label="email">✉️</span>
              <a href="mailto:nikhil@rookus.in" style={{ color: '#fff', textDecoration: 'none', marginLeft: '0.5rem' }}>nikhil@rookus.in</a>
            </div>
          </div>
